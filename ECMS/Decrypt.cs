...
namespace ECMS
{
    public class Decrypt
    {
        ...
        private string _Decrypt(string cipherText, string Key)
        {
        ...
        public string Decrypt256bits(string cipherText)
        { return _Decrypt(cipherText); }
        public string Decrypt256bits(string cipherText, string Key)
